...
\begin{table}[t]
\centering
\caption{Bounding the learned listener (Environment A, 400 cycles, 8 seeds per condition; premium $=0.112$; recipe $\lambda=0.3$ unless noted). ``Sat.''\ is the listener's converged decode accuracy over the episode. The decisive contrast is the last block: at the weight matched to the bounded reward's scale, recursion versus no recursion is worth $0.073$ ($t\approx4.0$).}
\label{tab:bounded}
...
Exclusivity $L_0$ ($n{=}8$) & $0.795\pm.081$ & n.s. & $.850$ & $-1.77$ \\
