...
\midrule
Simple $L_0$ & $0.911\pm.014$ & $59\%$ & $.856$ & $-0.77$ \\
Exclusivity $L_0$ & $0.863\pm.010$ & $16\%$ & $.852$ & $-1.77$ \\
Progress $L_0$ & $0.910\pm.016$ & $58\%$ & $.860$ & $+0.04$ \\
Filter $L_0$ & $0.915\pm.012$ & $63\%$ & $.859$ & $+0.33$ \\
\midrule
...
Filter + ear & $0.897\pm.023$ & $46\%$ & $.852$ & $+0.47$ \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{Information profile: per-timestep decode accuracy of a fresh post-hoc probe on each condition's converged behavior (first 26 steps shown; all conditions saturate by $t{\approx}17$). Filter-listener scouts are decodable earliest; oracle scouts, whose teams never rely on motion, are the \emph{least} legible early.}
...
$\lambda$ / VOI post-key weight (Env.\ A) & 0.3 / 0.2 \\
...
Seeds (headline / other conditions) & 6 / 3 \\
\bottomrule
\end{tabular}
\end{table}
