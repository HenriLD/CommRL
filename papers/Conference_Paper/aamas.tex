...
\begin{tabular}{@{}lccc@{}}
\toprule
\textbf{Reader (grounding)} & Baseline & Oracle & Progress \\
\midrule
Geometric (human prior) & $.419$ & $.418$ & $.411$ \\
IPL (frozen policy) & $.720$ & $.626$ & $.749$ \\
Fitted, own seed & $.742$ & $.547$ & $.829$ \\
Fitted, other seeds & $.720$ & $.537$ & $.820$ \\
\bottomrule
\end{tabular}
\end{table}
