...
Learned $\Ltheta$ & $\mathbf{1.93\pm.06}$ & $.847$ & $+0.21$ & $.644$ & $.672$ \\
Learned + RSA & $1.87\pm.02$ & $.837$ & $\mathbf{+0.22}$ & $\mathbf{.690}$ & $.684$ \\
\bottomrule
\end{tabular}
\end{table}
